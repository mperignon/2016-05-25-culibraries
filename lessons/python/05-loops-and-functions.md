...
In this example, `letter` is the loop variable that sequentially takes the value of each character in `word` every time the loop goes around. We can call the loop variable
